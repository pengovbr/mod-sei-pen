...
class Cenario009Test extends CenarioBaseTestCase
{
    public function test_tramitar_processo_restrito()
    {
        ...
        $processoTeste["HIPOTESE_LEGAL"] = $remetente["HIPOTESE_RESTRICAO"];
    ...
    public function test_tramitar_processo_com_documento_restrito()
    {
        ...
        $documentoTeste["HIPOTESE_LEGAL"] = $remetente["HIPOTESE_RESTRICAO"];       
        $this->cadastrarDocumentoInterno($documentoTeste);
        $this->assinarDocumento($remetente['ORGAO'], $remetente['CARGO_ASSINATURA'], $remetente['SENHA']);
