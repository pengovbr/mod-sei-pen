...
class PenAtualizarSipRN extends InfraRN
{
  ...
  protected function instalarV3034()
  {
    ...
    $this->criarRecurso('pen_map_tipo_processo_padrao', 'Importar tipos de processoa', $numIdSistema);
    $this->criarRecurso('pen_map_tipo_processo_padrao_salvar', 'Importar tipos de processoa', $numIdSistema);
