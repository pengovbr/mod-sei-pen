...
class PenAtualizarSeiRN extends PenAtualizadorRN
{
  ...
  protected function deletaParametroInfra($strNome)
    ...
    /**
     * Remove todos os í­ndices criados para o conjunto de tabelas informado
     */
  ...
  protected function instalarV100()
    ...
    try {
      ...
      // Tramitação externa do processo @processo@ concluí­da com sucesso. Recebido na @UnidadeDestino@ - @hierarquia_superior@ -@repositório_de_estruturas@
      ...
      $fnAtualizar('PEN_OPERACAO_EXTERNA', 'Tramitação externa do processo @PROTOCOLO_FORMATADO@ concluí­da com sucesso. Recebido em @UNIDADE_DESTINO@ - @UNIDADE_DESTINO_HIRARQUIA@ - @REPOSITORIO_DESTINO@');
  ...
  protected function instalarV2000_beta1()
    ...
    try {
        $this->logar("ATUALIZANDO LISTA DE HIPóTESES LEGAIS DO BARRAMENTO DE SERVIÃ‡OS PEN");
