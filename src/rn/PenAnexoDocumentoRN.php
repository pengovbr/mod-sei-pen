...
class PenAnexoDocumentoRN extends InfraRN
{
  ...
  protected function listarConectado(PenAnexoDocumentoDTO $objPenAnexoDocumentoDTO)
    {
    try {
        $objPenAnexoDocumentoBD = new PenAnexoDocumentoBD($this->getObjInfraIBanco());
        return $objPenAnexoDocumentoBD->listar($objPenAnexoDocumentoDTO);
    } catch (Exception $e) {
        throw new InfraException('Módulo do Tramita: Erro listando anexo de documentos.', $e);
    }
  }
