  ...
  switch ($_GET['acao']) {
    case 'pen_reproduzir_ultimo_tramite':
      try {
        ...
        $msgAlert = $result['error'] ? 'Erro! '.mb_convert_encoding($result['message'], 'ISO-8859-1', 'UTF-8') : 'Reprodução de último trâmite executado com sucesso! NRE:'.$nre.', IDT:'.$novoIDT.',TicketEnvioComponentesDigitais:'.$ticketComponentesDigitais;
        echo '
