...
class ProcessoEletronicoINT extends InfraINT {
    ...
    const TEE_EXPEDICAO_LOTE_ETAPA_CONCLUSAO = 'Processo(s) aguardando envio. Favor acompanhar a tramita̤̣o por meio do bloco, na funcionalidade \'Blocos de Tr̢mite Externo\'';
