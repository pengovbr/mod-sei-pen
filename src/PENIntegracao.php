...
class PENIntegracao extends SeiIntegracao
{
  ...
  protected function validarDesativarExcluirTipoProcesso($arrObjTipoProcedimentoDTO,$strDesativarExcluir) {
    ...
    $mensagem = "Prezado(a) usu·rio(a), vocÍ est· tentando ".$strDesativarExcluir." um Tipo de Processo que se encontra mapeado para o(s) relacionamento(s) "
    ...
    $mensagem = 'Prezado(a) usu·rio(a), vocÍ est· tentando '.$strDesativarExcluir.' o Tipo de Processo "%s" '
      ...
      . 'AdministraÁ„o -> Processo EletrÙnico Nacional -> Mapeamento de Tipos de Processo -> Relacionamento entre Unidades';
  ...
  /**
   * MÈtodo de formata√ß√£o para caracteres especiais XML
   */
  ...
  public static function verificarCompatibilidadeConfiguracoes(){
    ...
    // Desativado verifica√ß√µes de compatibilidade do banco de dados por n√£o ser todas as versıes
  ...
  /**
   * Compara duas diferentes versıes do sistem para avaliar a preced√™ncia de ambas
   *
