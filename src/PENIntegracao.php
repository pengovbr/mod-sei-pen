...
class PENIntegracao extends SeiIntegracao
{
  ...
  public function desativarTipoProcesso($arrObjTipoProcedimentoDTO)
  {
    ...
    $mensagem = 'Prezado(a) usu·rio(a), vocÍ est· tentando inativar o Tipo de Processo "%s" '
      ...
      . 'AdministraÁ„o -> Processo EletrÙnico Nacional -> Mapeamento de Tipos de Processo -> Relacionamento entre ”rg„os';
