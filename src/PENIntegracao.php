...
class PENIntegracao extends SeiIntegracao
{
  ...
  public function assinarDocumento($arrObjDocumentoAPI)
  {
    ...
    if($objComponenteDigitalBD->contar($objComponenteDigitalDTO) > 0){
      ...
      $objInfraException->adicionarValidacao('O Documento foi tramitado anteriormente por meio da plataforma Tramita.GOV.BR. Por esse motivo, n„o È possÌvel a inclus„o de novas assinaturas.');
