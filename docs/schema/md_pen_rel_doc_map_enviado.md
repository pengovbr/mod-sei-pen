...
```sql
CREATE TABLE `md_pen_rel_doc_map_enviado` (
...
| ---- | ---- | ---------- |
| fk_md_pen_rel_doc_map_env_espe | FOREIGN KEY | FOREIGN KEY (codigo_especie) REFERENCES md_pen_especie_documental (id_especie) |
| fk_md_pen_rel_doc_map_env_seri | FOREIGN KEY | FOREIGN KEY (id_serie) REFERENCES serie (id_serie) |
...
| Name | Definition |
| ---- | ---------- |
| fk_md_pen_rel_doc_map_env_espe | KEY fk_md_pen_rel_doc_map_env_espe (codigo_especie) USING BTREE |
| fk_md_pen_rel_doc_map_env_seri | KEY fk_md_pen_rel_doc_map_env_seri (id_serie) USING BTREE |
| PRIMARY | PRIMARY KEY (id_mapeamento) USING BTREE |

## Relations

![er](md_pen_rel_doc_map_enviado.svg)
