# NOTAS DE VERSÃO MOD-SEI-PEN (versão 3.1.18)
...
#### Tratamento de erro em consulta de metadados de outro órgãos

Implementado tratamento de erro em consulta de metadados do processo proveniente de outras instituições.
