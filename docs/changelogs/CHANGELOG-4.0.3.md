# NOTAS DE VERSÃO MOD-SEI-PEN (versão 4.0.3)
...
* O módulo é compatível com a seguinte versão do **SEI**:
  * SEI 5.0.0, 5.0.1, 5.0.2, 5.0.3 e 5.0.4
...
#### **CORREÇÕES DE PROBLEMAS / MELHORIAS**

#### Nesta versão, contemplados as seguintes melhorias/correções:

* **Compatibilização do SEI 5.0.4 com o módulo do Tramita:** Libera a compatibilização do módulo do Tramita 4.0.3 com o SEI versão 5.0.4.  [#1105](https://github.com/pengovbr/mod-sei-pen/issues/1151);
