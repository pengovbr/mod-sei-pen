# NOTAS DE VERSÃO MOD-SEI-PEN (versão 3.8.0)
...
* **Atualização do padrão de api de SOAP para REST:** Remoção da biblioteca BeSimpleSOAP. Alterar os nomes dos atributos que foram alterados do XML para REST/JSON. [#371](https://github.com/pengovbr/mod-sei-pen/issues/371);
