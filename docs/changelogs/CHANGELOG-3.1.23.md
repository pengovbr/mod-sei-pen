...
#### feat: altera regra para listagem das unidades organizacionais (#184)

Unidades somente envio, somente recebimento e receber/enviar são listadas no mapeamento de unidades.
Para envio externo somente as unidades de recebimento e receber/enviar são listadas.

#### fix: adiciona scroll no iframe de error (#134)

Ao apresentar um erro no envio externo exibe scroll para visulização completa da mensagem de erro.
