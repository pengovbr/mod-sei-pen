...
#### Versão de compatibilização com novas versões do SEI e SUPER

Foi realizado testes funcionais e liberado nova versão sem diferenças funcionais com a versão 3.2.0.
