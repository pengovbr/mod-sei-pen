...
/**
 * Issue #1228 - MESMO CENARIO, DIRECAO INVERTIDA (ORG2 cria e cancela; ORG1 devolve).
 * Relatado por testador: funciona na ida e falha na volta. Este teste verifica
 * se a assimetria existe no nosso codigo.
 *
 * Documento novo incluido pelo destino nao chegava na origem
 ...
 *
 * Execution Groups
 * #[Group('execute_alone_group8')]
 */
class TramiteSincronizacaoAposCancelamentoDocumentoInversoTest extends FixtureCenarioBaseTestCase
{
    ...
    {
        // Direcao invertida: quem cria e o ORG2, entao as fixtures precisam
        // gravar no banco dele. Sem isso o processo nasce no ORG1 e a tela
        // do ORG2 nao acha nada.
        ...
        $this->habilitarMultiplosOrgaos(self::$destinatario, CONTEXTO_ORGAO_B);
    ...
    {
        $arrRemetenteDevolucao = $this->definirContextoTeste(CONTEXTO_ORGAO_A);
        // Mesmo conteudo do documento cancelado: exige recuperar o componente
        // quando o barramento nao o informa como pendente de recebimento.
