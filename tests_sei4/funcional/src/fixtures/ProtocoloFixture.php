...
class ProtocoloFixture extends FixtureBase
{
    ...
    protected function cadastrar($dados = [])
    {
        ...
        $this->objProtocoloDTO->setStrDescricao($dados["Descricao"] ?: null);
        ...
        $this->objProtocoloDTO->setStrStaNivelAcessoGlobal($dados["StaNivelAcessoGlobal"] ?: $this->objProtocoloRN::$NA_PUBLICO);
        $this->objProtocoloDTO->setStrStaNivelAcessoLocal($dados["StaNivelAcessoLocal"] ?: $this->objProtocoloRN::$NA_PUBLICO);
    ...
    {
        $this->objProtocoloDTO->setStrProtocoloFormatado($dados['ProtocoloFormatado']);
        $this->objProtocoloDTO->retTodos();
        $objProtocoloDB = new \ProtocoloBD(\BancoSEI::getInstance());
        return $objProtocoloDB->listar($this->objProtocoloDTO);
    }

    public function getProtocoloTeste($protocolo, $documento = false)
    {   
