...
class TramiteProcessoContendoDocumentoAssinadoTest extends CenarioBaseTestCase
{
    ...
    /**
     * Teste de assinatura de um documento com certificado digital que foi tramitado anteriormente.
     *
     * @group verificacao_recebimento
     * @large
     *
     * @depends test_assinar_documento_de_tramite_anterior
     *
     * @return void
     */
    public function test_assinar_documento_com_certificado_digital_de_tramite_anterior()
    {

        self::$remetente = $this->definirContextoTeste(CONTEXTO_ORGAO_A);
        $this->assinarDocumentoCertificadoDigitalTramitadoAnteriormente(self::$remetente, self::$protocoloTeste);
    }
