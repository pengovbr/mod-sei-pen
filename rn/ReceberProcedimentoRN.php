...
class ReceberProcedimentoRN extends InfraRN
{
    ...
    */
    ...
    /**
     * Cancela os documentos no processo, verificando se os mesmos já tinha sido cancelados anteriormente
     *
     * @param array $parArrIdDocumentosCancelamento Lista de documentos que serão cancelados
     * @return void
     */
